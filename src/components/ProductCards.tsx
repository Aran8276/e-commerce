    ...
    return (
        <>
            {props.isDummy
                ...
                <div className={"text-sm " + props.scale + " h-fit "}>
                    ...
                    {props.isDiscount ?
                        <div className="flex space-x-4">
                            <div className="mt-2 font-bold line-through">${props.price}</div>
                            <div className="mt-2 font-bold">${props.discountPrice}</div>
                        </div>
                ...
                <Link href={"/shop/product/" + props.databaseId} className={"text-sm " + props.scale + " h-fit "}>
                    <img className={props.scaleAlt} src={props.src}></img>
                    <div className="mt-12">{props.title}</div>
                    {props.isDiscount ?
                        <div>

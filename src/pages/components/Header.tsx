        ...
        <header className="flex justify-between sticky top-0 z-10 bg-white">
            ...
            <div className="flex space-x-6 justify-items-center">
                ...
                <nav className="flex justify-start space-x-8 self-center text-center">
                    ...
                    {user?
                    user.isAdmin?
                    <Link href="/admin"><span className={props.currentNav == 'admin' ? "opacity-100" : "opacity-50 hover:opacity-75"}>Admin</span></Link>
            ...
            <div className="flex self-center mr-12 space-x-8">
                <div>
                    <form className="self-center space-x-4">
                        <input placeholder="Search" className="text-sm border-[1px] rounded-full px-4 py-1 h-[2.14rem] w-[12rem] border-gray-700" />
                        <a href=""><FontAwesomeIcon icon={faMagnifyingGlass} /></a>
                    </form>
                </div>

                <div className="self-center">
                    <Link href="/login"><span className="">Login</span></Link>
                </div>

                <div className="self-center">
                    <Link href="/shop/cart"><FontAwesomeIcon icon={faBagShopping} /></Link>
                </div>
            </div>
        </header>
        )

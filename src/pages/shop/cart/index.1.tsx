...
import CartContent from '@/pages/components/CartContent';
      ...
      <main className="mx-11">
        ...
        <div className="flex justify-center space-x-16 mt-12">
          <div>
            ...
            <CartContent id={1} updateTotalPrice={updateTotalPrice} price={100} title="MacBook Air" quantity={1} spec1='M2 Pro' spec2='512GB NVMe SSD' spec3='16GB RAM' src="https://store.storeimages.cdn-apple.com/4982/as-images.apple.com/is/macbook-air-silver-select-201810?wid=1078&hei=624&fmt=png-alpha&.v=1664472289056" />
            <CartContent id={2} updateTotalPrice={updateTotalPrice} price={100} title="MacBook Pro" quantity={1} spec1='M1 Max' spec2='1TB NVMe SSD' spec3='32GB RAM' src="https://store.storeimages.cdn-apple.com/4982/as-images.apple.com/is/refurb-mbp13-space-m1-2020?wid=1144&hei=1144&fmt=jpeg&qlt=90&.v=1628621779000" />
            <CartContent id={3} updateTotalPrice={updateTotalPrice} price={100} title="Razer BlackWidow V3 Pro Mechanical Wireless Gaming Keyboard" quantity={1} spec1='Razer Chroma™ RGB' src="https://dl.razerzone.com/src2/3808/3808-1-en-v3.png" />
            <CartContent id={4} updateTotalPrice={updateTotalPrice} price={100} title="Razer BlackWidow V3 Pro Mechanical Wireless Gaming Keyboard" quantity={1} spec1='Razer Chroma™ RGB' src="https://dl.razerzone.com/src2/3808/3808-1-en-v3.png" />
            <CartContent id={5} updateTotalPrice={updateTotalPrice} price={100} title="Razer BlackWidow V3 Pro Mechanical Wireless Gaming Keyboard" quantity={1} spec1='Razer Chroma™ RGB' src="https://dl.razerzone.com/src2/3808/3808-1-en-v3.png" />

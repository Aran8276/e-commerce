                ...
                <div className="flex justify-start">
                    <div className="flex flex-col">
                        <PromotionDeal
                            ...
                            textPos="relative right-[17rem] top-[7.25rem]"
                            customStyle=" ml-12 mt-12 "
                                    ...
                                    <div className="flex flex-col justify-start">
                                        ...
                                        <div className="flex relative mt-12 flex-col">
                                            ...
                                            <div className="flex flex-col mt-3 rounded-lg">
                                                ...
                                                <input
                                                    type="range"
                                                    list="markers"
                                                    className="w-52 mt-4 accent-indigo-600 h-[1px]"
                                                    min={0}
                                                    max={800}
                                                    value={value}
                                                    onChange={e =>
                                        ...
                                        <div className="flex relative mt-12 flex-col">
                                            ...
                                            <div className="mt-4">
                                                <a
                                                    href=""
                                                    className="text-center justify-center bg-[#0071e3] text-white px-3 py-1 rounded-md">
                                                    Apply Filters
                                                </a>
                                            </div>
                                        </div>
